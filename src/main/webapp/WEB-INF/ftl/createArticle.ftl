...
<div style="margin: 0 auto;
    ...
    <form action="/articles" method="post" enctype="multipart/form-data">
        ...
        <input name="articleFile" type="file" id="articleFile" title="Выбрать файл" style="width: 30%">
        <button type="submit">Отправить! (+200$)</button>
    </form>
</div>

<div class="p-5 mb-4 bg-light rounded-3">
    <div class="container-fluid py-5">
        <h2 class="display-5 fw-bold">Написать статью</h2>
        ...
        <form action="/articles" method="post" enctype="multipart/form-data">
            ...
            <input name="articleFile" type="file" id="articleFile" title="Выбрать файл" style="width: 30%"><br>
            <button class="btn btn-primary" type="submit">Отправить! (+200$)</button>
        </form>
    </div>
</div>
